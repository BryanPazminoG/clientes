...
import com.banquito.core.banking.clientes.domain.Direccion;
import com.banquito.core.banking.clientes.domain.Telefono;
...
public class ClienteBuilder {
    ...
    public static ClienteDTO toDTO(Cliente cliente) {
        ...
        for (Direccion direcccion : cliente.getDirecciones()) {
    ...
    public static Cliente copyCliente(Cliente source, Cliente destiny) {
        ...
        destiny.setDirecciones(source.getDirecciones());
        destiny.setTelefonos(source.getTelefonos());
        return destiny;
    }
}
