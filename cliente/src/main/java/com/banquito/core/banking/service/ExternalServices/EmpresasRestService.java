...
public class EmpresasRestService {
    ...
    public ResponseEntity<String> listarEmpresas() {
        String url = "https://clientes-atnhilz3dq-rj.a.run.app:8082/api/v1/empresas";
        return restTemplate.getForEntity(url, String.class);
    }

    public ResponseEntity<String> obtenerPorId(String id) {
        String url = UriComponentsBuilder.fromHttpUrl("https://clientes-atnhilz3dq-rj.a.run.app:8082/api/v1/empresas")
                .path("/{id}")
                .buildAndExpand(id)
                .toUriString();
        return restTemplate.getForEntity(url, String.class);
